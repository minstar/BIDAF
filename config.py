...
flags.DEFINE_integer('char_dimension', 15, 'choose the character dimension')
flags.DEFINE_integer('batch_size', 8, 'batch size of training time')
flags.DEFINE_integer('max_text', 677, 'max paragraph sizes')
flags.DEFINE_integer('max_num_query', 31, 'max number of query sizes')
flags.DEFINE_integer('max_query', 53, 'max query sizes')
flags.DEFINE_integer('max_num_answer', 8, 'max number of query answers')
flags.DEFINE_integer('max_answer', 92, 'max number of answer words')
